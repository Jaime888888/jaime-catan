...
This private repository copy is maintained by **Jaime Martin**. It is derived from `jason136/catan`; the original Git commit history and contributor attribution are preserved.

No project-level license was present in the source repository when this copy was created. Do not publish, redistribute, or relicense the code without authorization from the applicable rights holders.

Catan is the property of its respective trademark and copyright holders. This project is an independent research implementation and is not affiliated with or endorsed by Catan Studio or Catan GmbH.
